                            ...
                            <ul class="feed-elements list-unstyled">
                                ...
                                <li class="clearfix">
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{ asset('assets') }}/admin/img/avatar-5.jpg" alt="person" class="img-fluid rounded-circle"></a>
                                ...
                                <li class="clearfix">
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{ asset('assets') }}/admin/img/avatar-2.jpg" alt="person" class="img-fluid rounded-circle"></a>
                                ...
                                <li class="clearfix">
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{ asset('assets') }}/admin/img/avatar-3.jpg" alt="person" class="img-fluid rounded-circle"></a>
                                ...
                                <li class="clearfix">
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{ asset('assets') }}/admin/img/avatar-1.jpg" alt="person" class="img-fluid rounded-circle"></a>
                                ...
                                <li class="clearfix">
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{ asset('assets') }}/admin/img/avatar-6.jpg" alt="person" class="img-fluid rounded-circle"></a>
